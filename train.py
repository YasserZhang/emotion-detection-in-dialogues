...
x_text, y = data_helper.load_all_data_and_labels(filenames)
...
#word matrix corresponding the vocabs
word_vectors = np.array(list(vocabs.values()))
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def train_step(x_batch, y_batch):
            ...
            if current_step % (FLAGS.evaluate_every//2) == 0:
